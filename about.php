...
<section class="header">
   ...
   <a href="home.php" class="logo">HOSPITAL MANAGMENT SYSTEM</a>
...
<section class="about">
   ...
   <div class="image">
      <img src="images/header-im-1.jpg" alt="">
   </div>
...
<section class="reviews">
   ...
   <h1 class="heading-title"> PATIENT REVIEWS </h1>
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>Patient</span>
            <img src="images/pic-1.png" alt="this is just a image">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>Patient</span>
            <img src="images/pic-2.png" alt="this is just a image">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>Patient</span>
            <img src="images/pic-3.png" alt="this is just a image">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>Patient</span>
            <img src="images/pic-4.png" alt="this is just a image">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>Patient</span>
            <img src="images/pic-5.png" alt="this is just a image ">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>Patient</span>
            <img src="images/pic-6.png" alt="this is just a image">
         </div>
...
<section class="footer">
   ...
   <div class="credit"> created by <span>shorya rakheha</span> | all rights reserved! </div>
